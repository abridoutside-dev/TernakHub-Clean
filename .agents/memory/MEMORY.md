...
- [Admin user Edge Function path](admin-user-edge-function-path.md) — Cloudflare Pages admin user operations use the platform-health dispatcher, never /api SPA routes.
