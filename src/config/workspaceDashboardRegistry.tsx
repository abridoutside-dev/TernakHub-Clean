...
const WORKSPACE_DASHBOARD_REGISTRY: Record<WorkspaceKind, WorkspaceDashboardConfig> = {
  ...
  Transport: {
    ...
    quickActions:       [
      { id: 'tambah-kendaraan', label: 'Tambah Kendaraan', icon: '🚛', route: `${WORKSPACE_REGISTRY.Transport.routeUtama}?action=vehicle` },
      { id: 'tugaskan-driver',  label: 'Tugaskan Driver',  icon: '👨‍✈️', route: `${WORKSPACE_REGISTRY.Transport.routeUtama}?action=driver` },
      { id: 'buat-pengiriman',  label: 'Buat Pengiriman',  icon: '📦', route: `${WORKSPACE_REGISTRY.Transport.routeUtama}?action=delivery` },
