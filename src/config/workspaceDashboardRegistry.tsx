...
const WORKSPACE_DASHBOARD_REGISTRY: Record<WorkspaceKind, WorkspaceDashboardConfig> = {
  ...
  DrugStore: {
    ...
    quickActions: [
      { id: 'tambah-produk',      label: 'Tambah Produk',      icon: '＋',  route: `${WORKSPACE_REGISTRY.DrugStore.routeUtama}?tab=operational&action=tambah-produk` },
      { id: 'stok-masuk',         label: 'Stok Masuk',         icon: '📥', route: `${WORKSPACE_REGISTRY.DrugStore.routeUtama}?tab=operational&action=stok-masuk` },
      { id: 'stok-keluar',        label: 'Stok Keluar',        icon: '📤', route: `${WORKSPACE_REGISTRY.DrugStore.routeUtama}?tab=operational&action=stok-keluar` },
      { id: 'penjualan',          label: 'Buat Penjualan',     icon: '🧾', route: `${WORKSPACE_REGISTRY.DrugStore.routeUtama}?tab=operational&action=penjualan` },
      { id: 'pembelian',          label: 'Buat Pembelian',     icon: '🛒', route: `${WORKSPACE_REGISTRY.DrugStore.routeUtama}?tab=operational&action=pembelian` },
      { id: 'penyesuaian-stok',   label: 'Penyesuaian Stok',  icon: '⚖️', route: `${WORKSPACE_REGISTRY.DrugStore.routeUtama}?tab=operational&action=penyesuaian-stok` },
    ],
