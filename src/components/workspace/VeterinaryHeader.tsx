...
interface VeterinaryHeaderProps {
  meta: VetWorkspaceMeta;
  tipeLabel: string;
  roleLabel: RoleLabel;
}

export default function VeterinaryHeader({ meta, tipeLabel, roleLabel: rl }: VeterinaryHeaderProps) {
  return (
    <div style={{
