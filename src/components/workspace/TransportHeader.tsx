...
interface TransportHeaderProps {
  meta: TransportWorkspaceMeta;
  roleLabel: RoleLabel;
}

export default function TransportHeader({ meta, roleLabel: rl }: TransportHeaderProps) {
  return (
    <div style={{
