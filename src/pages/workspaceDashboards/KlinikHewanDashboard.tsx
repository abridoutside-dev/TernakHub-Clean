  ...
  return (
    <WorkspaceCard style={{ borderColor: '#c7d2fe', background: '#eef2ff' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
        ...
        <div>
          <h2 style={{ margin: 0, fontSize: 14, fontWeight: 800, color: '#312e81' }}>AI Insight Klinik Hewan</h2>
          <span style={{
      ...
      <p style={{ margin: 0, fontSize: 11, color: '#4338ca', lineHeight: 1.6 }}>
        ...
        (health_checkups, health_treatments, health_control_schedules, activity_log) dan memanggil
        AI service yang akan diintegrasikan kemudian.
      </p>
      <div style={{ marginTop: 10, display: 'flex', flexDirection: 'column', gap: 5 }}>
        {[
          'Tren diagnosis paling umum berdasarkan health_checkups.diagnosis',
          'Pola tindakan medis berulang dari health_treatments',
          'Prediksi beban kunjungan berdasarkan jadwal mendatang',
          'Rekomendasi optimasi jadwal dokter klinik',
        ].map((item) => (
