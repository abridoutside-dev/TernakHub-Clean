// ─── DokterHewanDashboard — WORKSPACE-001B ───────────────────────────────────
// Placeholder dashboard untuk Workspace Dokter Hewan.
...
export default function DokterHewanDashboard(): React.ReactElement {
  return (
    <div style={{ padding: '40px 16px', textAlign: 'center', color: 'var(--color-muted)' }}>
      ...
      <p style={{ margin: 0, fontSize: 14 }}>Dashboard Dokter Hewan segera hadir.</p>
    </div>
  );
}
